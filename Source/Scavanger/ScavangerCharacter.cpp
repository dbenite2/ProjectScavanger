...
AScavangerCharacter::AScavangerCharacter()
{
...
void AScavangerCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AScavangerCharacter::Move);
...
void AScavangerCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AScavangerCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
